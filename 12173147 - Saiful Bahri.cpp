...
clrscr();
atas() ;
cout<<"No  Nim	   Nama	 	Nilai UTS     Nilai UAS     Total     Ket	\n";
for(i=1;i<=j;i++)
{
...
cout<<setiosflags(ios::right)<<setw(15)<<mhs[i].uas;
cout<<setiosflags(ios::right)<<setw(15)<<mhs[i].hasil;
cout<<setiosflags(ios::right)<<setw(8)<<ket(mhs[i].hasil);
}
 	getch();
 }
